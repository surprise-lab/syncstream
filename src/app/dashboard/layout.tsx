...
const navLinks = [
  ...
  { href: '/dashboard/integrations/health', label: 'Health', icon: 'favorite' },
            ...
            <Link
              ...
              className={cn(
                ...
                pathname.startsWith(link.href) &&
                  link.href !== '/dashboard' &&
                  link.href !== '#' &&
                  'bg-primary-800/20 text-primary-400'
              )}
            >
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center justify-between border-b border-gray-800 bg-gray-900 px-6">
          <div className="flex items-center gap-4">
            <h1 className="text-xl font-semibold">System Health Overview</h1>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAoqwLlHuHKE4qqoInIc-mMgqmZPzXErer8JY-Jk4tTq9Vb2fhxDnBgAqcrU-ITCAr0QoOnPhF7BNLXJ916YSAqhX1EZQMPSQrn7tOn-LB1qlcxbK_ztOaCAP56Ur4h5dFuMMycB5sIGbtcA7n19PpEPOQsRuvC1oRdOt7TRlCMktKYxtnN02CEZbs-s1jw80HTS9TXuHGAriKmdgzum7Zy2sL6qXC9H0YpDAcgKPxMoZjHlOoAMSwKeY1mwPH4YVe98Nya_fONlu6k")',
              }}
            ></div>
          </div>
        </header>
