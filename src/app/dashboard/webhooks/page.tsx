...
export default function WebhooksPage() {
  ...
  "status": "received"
        ...
        <div className="bg-[#161B22] border border-[#30363D] rounded-lg mt-8">
          <div className="px-6 py-4 border-b border-[#30363D]">
            <h3 className="text-lg font-semibold text-white">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left text-[#C9D1D9]">
              <thead className="bg-[#21262D] text-xs uppercase">
                <tr>
              ...
              <tbody>
                <tr className="border-b border-[#30363D] hover:bg-[#21262D]/50">
                  ...
                  <td className="px-6 py-4">
                    <span className="bg-[#21262D] border border-[#30363D] text-[#8B949E] text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">
                      order.created
                    </span>
                  </td>
                  <td className="px-6 py-4 text-xs font-mono">
                    2024-07-26 10:30:15 UTC
                  </td>
                  <td className="px-6 py-4 text-xs font-mono">del_abc123</td>
                  <td className="px-6 py-4 text-right">
                    <button className="text-[#8B949E] hover:text-[var(--primary-400)] transition-colors text-sm font-medium">
                      View Payload
                    </button>
                  </td>
                </tr>
                <tr className="border-b border-[#30363D] hover:bg-[#21262D]/50">
                  ...
                  <td className="px-6 py-4 text-xs font-mono">del_def456</td>
                  <td className="px-6 py-4 text-right">
                    <button className="text-[#8B949E] hover:text-[var(--primary-400)] transition-colors text-sm font-medium">
                      View Payload
                    </button>
                ...
                <tr className="border-b border-[#30363D] hover:bg-[#21262D]/50">
                  ...
                  <td className="px-6 py-4 text-xs font-mono">
                    2024-07-26 10:25:01 UTC
                  </td>
                  <td className="px-6 py-4 text-xs font-mono">del_ghi789</td>
                  <td className="px-6 py-4 text-right">
                    <button className="text-[#8B949E] hover:text-[var(--primary-400)] transition-colors text-sm font-medium">
                      View Payload
                    </button>
          ...
          <div className="px-6 py-4 bg-[#161B22] flex justify-end">
            <button className="text-sm font-medium text-[var(--primary-400)] hover:text-[var(--primary-300)]">
              View all logs
            </button>
          </div>
        </div>
